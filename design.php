            ...
            <div class="swiper-container" id="preview">
                ...
                <div class="swiper-wrapper">
                    <!-- Slides -->
						...
						<img id="bg1" src="img/bg1.png" alt="bg1" width="0" height="0">
						<img id="bg2" src="img/bg2.png" alt="bg2" width="0" height="0">
						<img id="water-mark" src="img/stamp.png" alt="water-mark" width="0" height="0">
                    <div class="swiper-slide"><canvas class=".imgSize280" id="myCanvas1" width="224" height="150" style="border:1px solid #000000;"></canvas></div>					
                    <div class="swiper-slide"><canvas class=".imgSize280" id="myCanvas2" width="224" height="150" style="border:1px solid #000000;"></canvas></div>
                </div>
